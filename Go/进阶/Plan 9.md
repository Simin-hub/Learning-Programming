...
[参考](https://golang.design/under-the-hood/zh-cn/part1basic/ch01basic/asm/)、[参考](https://studygolang.com/articles/33163)、

Go使用的汇编叫做`plan9汇编`这些东西的确我们现在使用的高级语言的编译器都帮助我们屏蔽掉了，但是今天我们要来学学Go的`plan9汇编`
...
所有汇编指令都可以转换为 0101 的序列，汇编指令相当于助记码，给人看的，实际内容是01序列，如：
...
**寄存器是中央处理器内的组成部分**。寄存器是有限存贮容量的高速存贮部件，它们可**用来暂存指令、数据和地址**。
...
[![img](https://github.com/cch123/asmshare/raw/master/images/asm_func.png)](https://github.com/cch123/asmshare/blob/master/images/asm_func.png)

...
|   操作   | 空值(nil) |              空（已定义）              |  已关闭  |               非空未关闭               |
| :------: | :-------: | :------------------------------------: | :------: | :------------------------------------: |
|   关闭   |   panic   |                成功关闭                |  panic   |                成功关闭                |
| 发送数据 | 永久阻塞  | 阻塞（同步通道）或成功发送（缓存通道） |  panic   | 阻塞（同步通道）或成功发送（缓存通道） |
| 接收数据 | 永久阻塞  |      阻塞（同步通道）或者成功接收      | 永不阻塞 |      阻塞（同步通道）或者成功接收      |
...
[参考](https://segmentfault.com/a/1190000023691221)

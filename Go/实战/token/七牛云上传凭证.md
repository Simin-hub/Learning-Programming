...
[原地址](https://github.com/qiniu/go-sdk/blob/master/examples/create_uptoken.go)、[参考](https://developer.qiniu.com/kodo/1238/go)
...
var (
	// accessKey 凭证的key（id）, secretKey 凭证的secret

...
[参考](https://mp.weixin.qq.com/s/r3ayFm_7kD07AAShcQF8xA)
...
很多时候我们会直接通过一个本地定时器来帮我们完成这个任务。如果我们的系统是多实例分布式的，本地定时器就会面临很多问题，如：怎么保证重复处理的问题；统一管控的问题等等。面对本地定时器遇到的问题，我们可以使用**分布式延迟队列来实现**。